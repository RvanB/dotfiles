...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Org mode
   `(org-level-1 ((,class (:foreground ,keyword-color :weight normal))))
   `(org-level-2 ((,class (:foreground ,function-color :weight normal))))
   `(org-level-3 ((,class (:foreground ,type-color :weight normal))))
   `(org-level-4 ((,class (:foreground ,git-branch-remote :weight normal))))
   `(org-level-5 ((,class (:foreground ,string-color :weight normal))))
   `(org-level-6 ((,class (:foreground ,keyword-color :weight normal))))
   `(org-level-7 ((,class (:foreground ,function-color :weight normal))))
   `(org-level-8 ((,class (:foreground ,type-color :weight normal))))
