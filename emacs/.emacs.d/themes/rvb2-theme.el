...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(diff-added ((,class (:foreground ,diff-green))))
   ...
   `(diff-hl-insert ((,class (:foreground ,diff-green))))
   `(diff-hl-delete ((,class (:foreground ,red-bright))))
   ...
   `(magit-diff-added ((,class (:foreground ,diff-green))))
